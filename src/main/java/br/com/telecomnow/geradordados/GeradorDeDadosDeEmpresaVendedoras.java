...
public class GeradorDeDadosDeEmpresaVendedoras {
    ...
    public Collection<EmpresaVendedora> gerarDados() {
        ...
        empresas.add(new EmpresaVendedora("Google", PLATINUM, "http://www.google.com", "img/logo-empresa.png"));
        empresas.add(new EmpresaVendedora("Apple", GOLD, "http://www.apple.com", "img/logo-empresa.png"));
        empresas.add(new EmpresaVendedora("HP", GOLD, "http://www.hp.com", "img/logo-empresa.png"));
        empresas.add(new EmpresaVendedora("DELL", SILVER, "http://www.dell.com", "img/logo-empresa.png"));
        empresas.add(new EmpresaVendedora("NeoGrid", SILVER, "http://www.neogrid.com", "img/logo-empresa.png"));
        return empresas;
    }
}
